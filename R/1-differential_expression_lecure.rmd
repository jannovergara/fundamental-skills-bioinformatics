...
```{r}
ge_matrix <- read.table('r-data/NCOMMS-19-7936188_bulk_RNAseq_raw_counts.txt.gz', 
                header = TRUE, sep = '\t')
dim(ge_matrix)
ge_matrix[1:4, 1:4]
...
```{r}
pheno_matrix <- read.table('r-data/NCOMMS-19-7936188_bulk_RNAseq_metadata.txt.gz', 
